/* File from https://github.com/arcuri82/web_development_and_api_design/blob/master/exercise-solutions/quiz-game/part-08/src/client/headerbar.jsx */
    ...
    renderLoggedIn(userId) {
        return (
            <React.Fragment>
                ...
                <button className="header-button" id="logoutBtnId" onClick={this.doLogout}>
                Logout
                </button>
            </React.Fragment>
        );
